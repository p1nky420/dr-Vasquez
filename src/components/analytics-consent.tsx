  ...
  return (
    <>
      ...
      {ready && consent === null ? (
        ...
        >
          <p className="text-[0.68rem] font-semibold uppercase tracking-[0.2em] text-[#c9ad78]">Privacidad</p>
          ...
          <div className="mt-4 grid grid-cols-2 gap-2">
            <button onClick={() => decide("rejected")} className="min-h-11 touch-manipulation border border-[#9a835b]/35 px-4 py-2 text-[0.68rem] font-semibold uppercase tracking-[0.14em] transition-colors hover:border-[#c9ad78]">Solo necesarias</button>
